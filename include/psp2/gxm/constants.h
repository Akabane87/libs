...
#ifndef _PSP2_GXM_CONSTANTS_H_
#define _PSP2_GXM_CONSTANTS_H_
...
typedef enum SceGxmColorBaseFormat {
	...
	SCE_GXM_COLOR_BASE_FORMAT_U8S8S8U8			= 0xd0800000U,	//!< 32-bit format, 8-bit unsigned, 8-bit signed, 8-bit signed and 8-bit unsigned integer
...
typedef enum SceGxmColorFormat {
	...
	SCE_GXM_COLOR_FORMAT_U8S8S8U8_ABGR		= SCE_GXM_COLOR_BASE_FORMAT_U8S8S8U8 | SCE_GXM_COLOR_SWIZZLE4_ABGR,		//!< Pixels are written to memory in U8S8S8U8 format in ABGR order.
	SCE_GXM_COLOR_FORMAT_U8U8S8S8_ARGB		= SCE_GXM_COLOR_BASE_FORMAT_U8S8S8U8 | SCE_GXM_COLOR_SWIZZLE4_ARGB,		//!< Pixels are written to memory in U8U8S8S8 format in ARGB order.
	SCE_GXM_COLOR_FORMAT_U8S8S8U8_RGBA		= SCE_GXM_COLOR_BASE_FORMAT_U8S8S8U8 | SCE_GXM_COLOR_SWIZZLE4_RGBA,		//!< Pixels are written to memory in U8S8S8U8 format in RGBA order.
	SCE_GXM_COLOR_FORMAT_S8S8U8U8_BGRA		= SCE_GXM_COLOR_BASE_FORMAT_U8S8S8U8 | SCE_GXM_COLOR_SWIZZLE4_BGRA,		//!< Pixels are written to memory in S8S8U8U8 format in BGRA order.
 ...
 * in screen space coordinates.  For a description of the usual transform see #sceGxmSetViewport().
 * 
 * @ingroup render
 */
